...
class Analyzer:
    def __init__(self, rootdir=None, outdir=None, plate=None, starttime=None, endtime=None, save_jpeg=False, save_buff=False, save_step=None, buffdir=None):
        self.plate = plate
        self.images = ImageManager(root=rootdir, plate=plate, starttime=starttime, endtime=endtime, backward=mp.finterval-1, save_jpeg=save_jpeg, save_buff=save_buff, save_step=save_step, buffdir=buffdir)
        self.nextstep = 0
